...
class MAPPORNNCriticShare(nn.Module):
    def __init__(self, scheme, args):
        ...
        self.input_seq_str = f"{args.config['critic_input_seq_str']}_{self.n_agents}_{self.n_actions}_{1}"
    ...
    def init_hidden(self, batch_size):
        ...
        self.hidden_states = hidden_states.unsqueeze(0).expand(batch_size, 1, -1)  # bav
