...
from MARL.modules.agents.whittle_index_network import WhittleIndexNetwork
...
from MARL.utils.input_utils import build_actor_inputs, get_actor_input_shape
...
class WhittleDiscreteMAC(object):
    ...
    def select_actions(
        self, ep_batch, t_ep, t_env, lbda_indices, bs=slice(None), test_mode=False
    ):
